...
<div class="container mx-auto p-5 bg-white rounded-lg shadow-lg">
    ...
    <form action="/format" method="POST">
        ...
        <div class="flex space-x-2 mb-4">
            <button type="submit" name="format" value="webattack"
                class="flex-1 p-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 focus:outline-none">Web
                Attack</button>
            ...
            <button type="submit" name="format" value="sangforips"
                class="flex-1 p-2 bg-red-200 text-gray-700 rounded-md hover:bg-red-300 focus:outline-none">Sangfor
                IPS</button>
        </div>
    </form>
    @if (isset($formattedText))
        <div class="mt-6">
            ...
            <div class="relative">
                <p id="formattedText" class="mt-2 p-4 bg-gray-100 border border-gray-300 rounded-md">{{ $formattedText }}
                </p>
